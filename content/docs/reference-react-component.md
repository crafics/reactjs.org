...
Note that React may call this method only if the props have changed. However, make sure to compare the current and next values if you only want to handle changes. This may occur when the parent component causes your component to re-render.
